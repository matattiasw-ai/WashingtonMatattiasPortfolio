...
# --- THEME DESIGN SYSTEM (Cool Garden Mint (Light)) ---
BG = '#F0FDF4'
SURFACE = '#FFFFFF'
TEXT = '#14532D'
MUTED = '#166534'
...
def main(page: ft.Page):
            ...
            ft.Container(
                ...
                content=ft.Column([
                    ...
                    ft.Row([
                        ...
                        ft.Text("matattiasw@gmail.com", color=MUTED, size=14, selectable=True),
                    ], wrap=True),
                    ft.Row([
                        ft.Icon(ft.Icons.LINK, size=15, color=ACCENT),
                        ft.Text("GitHub Profile: github.com/matattiasw-ai", color=ACCENT, size=14, selectable=True)
                    ], wrap=True),
                ], spacing=12)
            ),
    ...
    # Files list
    files_list = []
    for f in ['README.md', 'package.json', 'project-management/final-integration-plan.md', 'project-management/work-division.md']:
        files_list.append(
            ft.Container(
                padding=10,
                border_radius=6,
        ...
        content=ft.ResponsiveRow([
            ...
            ft.Container(
                ...
                content=tile_card("My Project Focus", [
                    ft.Text("Integration review, package scripts, and final coordination docs.", size=14, color=TEXT),
            ...
            ft.Container(
                ...
                content=tile_card("Submission Information", [
                    ...
                    ft.Text('git config user.name "Washington Matattias"\ngit config user.email "matattiasw@gmail.com"', size=11, font_family="Consolas", color=TEXT, selectable=True),
                    ft.Divider(color=BORDER),
    ...
    footer = ft.Container(
        ...
        content=ft.Column([
            ft.Text("Washington Matattias | SiteSpy Portfolio Showcase", color=TEXT, size=14, weight=ft.FontWeight.BOLD),
